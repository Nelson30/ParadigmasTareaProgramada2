...
public final class Checker implements Visitor {
  ...
  public Object visitAssignCommand(AssignCommand ast, Object o) {
    ...
    if (!eType.equals(vType)) reporter.reportError("assignment incompatibilty", "", ast.position);
    return null;
  }
  ...
  public Object visitCallCommand(CallCommand ast, Object o) {
    ...
    if (binding == null) reportUndeclared(ast.I);
  ...
  public Object visitBinaryExpression(BinaryExpression ast, Object o) {
    ...
    if (binding == null) reportUndeclared(ast.O);
    else {
      ...
      if (bbinding.ARG1 == StdEnvironment.anyType) {
        ...
        if (!e1Type.equals(e2Type))
          reporter.reportError(
              "incompatible argument types for \"%\"", ast.O.spelling, ast.position);
  ...
  public Object visitProcActualParameter(ProcActualParameter ast, Object o) {
    ...
    if (binding == null) reportUndeclared(ast.I);
      ...
      FormalParameterSequence FPS = null;
      if (binding instanceof ProcDeclaration) FPS = ((ProcDeclaration) binding).FPS;
      else FPS = ((ProcFormalParameter) binding).FPS;
  ...
  public Object visitIdentifier(Identifier I, Object o) {
    ...
    if (binding != null) I.decl = binding;
    return binding;
  }
  ...
  public Object visitOperator(Operator O, Object o) {
    ...
    if (binding != null) O.decl = binding;
    return binding;
  }
  ...
  public Object visitSimpleVname(SimpleVname ast, Object o) {
    ...
    if (binding == null) reportUndeclared(ast.I);
      ...
      reporter.reportError(
          "\"%\" is not a const or var identifier", ast.I.spelling, ast.I.position);
    return ast.type;
  }
  ...
  public Object visitRepeatCommand(RepeatCommand repeatCommand, Object o) {
    TypeDenoter eType = (TypeDenoter) repeatCommand.E.visit(this, null);
    if (!eType.equals(StdEnvironment.booleanType))
      reporter.reportError("Boolean expression expected here", "", repeatCommand.E.position);
    repeatCommand.C.visit(this, null);
    return null;
  }

  @Override
  public Object visitZZCommand(ZZCommand zzCommand, Object o) {
    TypeDenoter eType = (TypeDenoter) zzCommand.v.visit(this, null);
    if (!eType.equals(StdEnvironment.integerType)) {
      reporter.reportError(" CAN'T APPLY THIS", "", zzCommand.v.position);
    }
    return null;
  }

  @Override
  public Object visitAddCommand(AddCommand addCommand, Object o) {
    TypeDenoter eType = (TypeDenoter) addCommand.v.visit(this, null);
    if (!eType.equals(StdEnvironment.integerType)) {
      reporter.reportError(" CAN'T APPLY THIS", "", addCommand.v.position);
    }
    return null;
  }
  ...
  public Object visitRunCommand(RunCommand runCommand, Object o) {
    ...
    TypeDenoter eType = (TypeDenoter) runCommand.v.visit(this, null);
    if (!eType.equals(StdEnvironment.integerType)) {
      reporter.reportError(" CAN'T APPLY THIS", "", runCommand.v.position);
    }
    return null;
  ...
  @Override
  public Object visitSubsCommand(SubsCommand subsCommand, Object o) {
    TypeDenoter eType = (TypeDenoter) subsCommand.v.visit(this, null);
    if (!eType.equals(StdEnvironment.integerType)) {
      reporter.reportError(" CAN'T APPLY THIS", "", subsCommand.v.position);
    }
    return null;
  }
  ...
  private ProcDeclaration declareStdProc(String id, FormalParameterSequence fps) {
    ...
    binding =
        new ProcDeclaration(
            new Identifier(id, dummyPos), fps,
  ...
  private FuncDeclaration declareStdFunc(
      String id, FormalParameterSequence fps, TypeDenoter resultType) {

    FuncDeclaration binding;

    binding =
        new FuncDeclaration(
            new Identifier(id, dummyPos), fps, resultType, new EmptyExpression(dummyPos), dummyPos);
    idTable.enter(id, binding);
    return binding;
  }
  ...
  private UnaryOperatorDeclaration declareStdUnaryOp(
    ...
    binding =
        new UnaryOperatorDeclaration(new Operator(op, dummyPos), argType, resultType, dummyPos);
  ...
  private BinaryOperatorDeclaration declareStdBinaryOp(
    ...
    binding =
        new BinaryOperatorDeclaration(
            new Operator(op, dummyPos), arg1Type, arg2type, resultType, dummyPos);
    idTable.enter(op, binding);
    return binding;
  }
  ...
  private void establishStdEnvironment() {
    ...
    StdEnvironment.notDecl =
        declareStdUnaryOp("\\", StdEnvironment.booleanType, StdEnvironment.booleanType);
    StdEnvironment.andDecl =
        declareStdBinaryOp(
            "/\\",
            StdEnvironment.booleanType,
            StdEnvironment.booleanType,
            StdEnvironment.booleanType);
    StdEnvironment.orDecl =
        declareStdBinaryOp(
            "\\/",
            StdEnvironment.booleanType,
            StdEnvironment.booleanType,
    ...
    StdEnvironment.multiplyDecl =
        declareStdBinaryOp(
            ...
            StdEnvironment.integerType,
            StdEnvironment.integerType);
    StdEnvironment.divideDecl =
        declareStdBinaryOp(
            "/",
            StdEnvironment.integerType,
            StdEnvironment.integerType,
            StdEnvironment.integerType);
    StdEnvironment.moduloDecl =
        declareStdBinaryOp(
            "//",
            StdEnvironment.integerType,
            StdEnvironment.integerType,
            StdEnvironment.integerType);
    StdEnvironment.lessDecl =
        declareStdBinaryOp(
            "<",
            StdEnvironment.integerType,
            StdEnvironment.integerType,
            StdEnvironment.booleanType);
    StdEnvironment.notgreaterDecl =
        declareStdBinaryOp(
            "<=",
            StdEnvironment.integerType,
            StdEnvironment.integerType,
            StdEnvironment.booleanType);
    StdEnvironment.greaterDecl =
        declareStdBinaryOp(
            ">",
            StdEnvironment.integerType,
            StdEnvironment.integerType,
            StdEnvironment.booleanType);
    StdEnvironment.notlessDecl =
        declareStdBinaryOp(
            ">=",
            StdEnvironment.integerType,
            StdEnvironment.integerType,
    ...
    StdEnvironment.eofDecl =
        declareStdFunc(
            "eof", new EmptyFormalParameterSequence(dummyPos), StdEnvironment.booleanType);
    StdEnvironment.eolDecl =
        declareStdFunc(
            "eol", new EmptyFormalParameterSequence(dummyPos), StdEnvironment.booleanType);
    ...
    StdEnvironment.geteolDecl =
        declareStdProc("geteol", new EmptyFormalParameterSequence(dummyPos));
    StdEnvironment.puteolDecl =
        declareStdProc("puteol", new EmptyFormalParameterSequence(dummyPos));
    StdEnvironment.equalDecl =
        declareStdBinaryOp(
            "=", StdEnvironment.anyType, StdEnvironment.anyType, StdEnvironment.booleanType);
    StdEnvironment.unequalDecl =
        declareStdBinaryOp(
            "\\=", StdEnvironment.anyType, StdEnvironment.anyType, StdEnvironment.booleanType);
  }
}
