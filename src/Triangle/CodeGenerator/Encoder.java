...
public final class Encoder implements Visitor {
  ...
  public Object visitLetCommand(LetCommand ast, Object o) {
    ...
    if (extraSize > 0) emit(Machine.POPop, 0, 0, extraSize);
    return null;
  }
  ...
  public Object visitLetExpression(LetExpression ast, Object o) {
    ...
    if (extraSize > 0) emit(Machine.POPop, valSize.intValue(), 0, extraSize);
    return valSize;
  }
  ...
  public Object visitVarFormalParameter(VarFormalParameter ast, Object o) {
    ...
    ast.T.visit(this, null);
    ast.entity =
        new UnknownAddress(Machine.addressSize, frame.level, -frame.size - Machine.addressSize);
    writeTableDetails(ast);
  ...
  public Object visitMultipleFieldTypeDenoter(MultipleFieldTypeDenoter ast, Object o) {
    ...
    if (ast.entity == null) {
      ...
      writeTableDetails(ast);
    } else fieldSize = ast.entity.size;
  ...
  public Object visitSubscriptVname(SubscriptVname ast, Object o) {
    ...
    if (ast.E instanceof IntegerExpression) {
      ...
      if (ast.indexed) frame.size = frame.size + Machine.integerSize;
      ...
      if (ast.indexed) emit(Machine.CALLop, Machine.SBr, Machine.PBr, Machine.addDisplacement);
      else ast.indexed = true;
    }
    return baseObject;
  }
  ...
  public Object visitZZCommand(ZZCommand ast, Object o) {
    Frame frame = (Frame) o;
  ...
  @Override
  public Object visitAddCommand(AddCommand ast, Object o) {
    Frame frame = (Frame) o;
    int jumpAddr, loopAddr;
  ...
  @Override
  public Object visitSubsCommand(SubsCommand ast, Object o) {
    Frame frame = (Frame) o;
    int jumpAddr, loopAddr;
  ...
  public void saveObjectProgram(String objectName) {
    ...
    try {
      ...
      addr = Machine.CB;
      for (addr = Machine.CB; addr < nextInstrAddr; addr++) Machine.code[addr].write(objectStream);
      objectFile.close();
  ...
  private int displayRegister(int currentLevel, int objectLevel) {
    if (objectLevel == 0) return Machine.SBr;
  ...
  private void encodeStore(Vname V, Frame frame, int valSize) {
    ...
    if (baseObject instanceof KnownAddress) {
      ...
      emit(
          ...
          displayRegister(frame.level, address.level),
          address.displacement);
      if (V.indexed) emit(Machine.CALLop, Machine.SBr, Machine.PBr, Machine.addDisplacement);
      if (V.offset != 0) {
  ...
  private void encodeFetch(Vname V, Frame frame, int valSize) {
    ...
    if (baseObject instanceof KnownValue) {
      ...
      ObjectAddress address =
          (baseObject instanceof UnknownValue)
